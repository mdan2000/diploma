...
def run_graph_part(f_name, spatial_size, n_channels, n_iter=100):
    ...
    with tf.compat.v1.Session() as sess:
        ...
        n_total_params = 0
        for v in tf.compat.v1.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='var_scope'):
...
if __name__ == '__main__':
    results = run_graph_part(conv_block, spatial_size=1024, n_channels=128, n_iter=1000)
